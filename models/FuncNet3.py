...
class FuncNet3(nn.Module):
    ...
    def __init__(self, num_classes=46, num_features_input=70, num_input_channels=1, non_linearity='ReLU',
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(256, 512, kernel_size=[3, 3], stride=(1, 1), padding=[1, 1]),  # 512
            nn.BatchNorm2d(512))
        ...
        self.rnn1 = PaddedRNN(mode=memory_type, input_size=rnn_input_size, hidden_size=512, num_layers=1, bidirectional=rnn_bidirectional, batchnorm=True)
        self.rnn2 = PaddedRNN(mode=memory_type, input_size=512, hidden_size=512, num_layers=1, bidirectional=rnn_bidirectional, batchnorm=False)
