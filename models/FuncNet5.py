...
class FuncNet5(nn.Module):
    ...
    def __init__(self, num_classes=46, num_features_input=70, num_input_channels=1, non_linearity='ReLU',
        ...
        self.rnn1 = PaddedRNN(mode=memory_type, input_size=rnn_input_size, hidden_size=512, num_layers=1, bidirectional=rnn_bidirectional, batchnorm=True, sum_bidirectional=True)
        self.rnn2 = PaddedRNN(mode=memory_type, input_size=512, hidden_size=512, num_layers=1, bidirectional=rnn_bidirectional, batchnorm=False, sum_bidirectional=True)
